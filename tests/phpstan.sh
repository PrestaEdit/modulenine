...
docker run -tid --rm -v ps-volume:/var/www/html --name temp-ps prestaedit/prestashop:$PS_VERSION

# Clear previous instance of the module in the PrestaShop volume
echo "Clear previous module"

docker exec -tid temp-ps rm -rf /var/www/html/modules/creativeelements
